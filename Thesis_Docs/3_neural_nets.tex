...
Since $\hat{p}_{data}$ is not a function of $\mathbf{\theta}$, Equation \ref{nnets-kl-eq} is equivalent to 
...
\end{align}
Both the \textsc{mle} of $\theta$ (Equation \ref{nnets-mle-eq}) and the minimiser of \textsc{kl}-divergence (Equation \ref{nnets-kl-eq2}) are equivalent to the minimiser of cross-entropy (Equation \ref{nnets-cross-entropy-eq}). 
