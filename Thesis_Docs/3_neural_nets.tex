...
\todo{Find supporting sources for gradient descent as opposed to solving analytically. ie that there is no closed form solution and that grad desc saves time.}
