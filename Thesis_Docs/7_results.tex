...
Between the two trained model, the model that was trained on more data had slightly less sensitivity but much greater specificity. 

\todo[inline]{Hypothesis tested the difference between the two models' sensitivities}

\todo[inline]{Discussion of model comparisons. Which one is truly preferred and why}
