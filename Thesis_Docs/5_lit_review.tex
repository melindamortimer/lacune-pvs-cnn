...
This section describes a number of models that were developed partially using machine learning techniques. 

The first attempts are made by Uchiyama et al. in 2007 \cite{Uchiyama20071554, Uchiyama2007b}. These models are a continuation of the model completed by Yokoyama et al. \cite{Yokoyama2007}. Once candidates have been identified, the models undergo false positive reduction. 12 location based features are identified: x and y coordinates, intensity differences in T1 and T2, 4 scales of nodular component extraction, and 4 scales of combined nodular and linear component extraction.
...
In 2015, Uchiyama et al. \cite{Uchiyama2015}, the models from 2007 were improved using template matching. These templates were generated from 
