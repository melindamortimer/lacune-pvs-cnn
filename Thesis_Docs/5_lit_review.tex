...
Each resolution is fed through its own 3D \textsc{cnn}, as shown in \textbf{Figure}. Each \textsc{cnn} branch contains six convolution layers, which have 64, 64, 128, 128, 256 and 256 filters of sizes 3$\times$3$\times$2, 3$\times$3$\times$2, 3$\times$3$\times$3$\times$1, 3$\times$3$\times$1, 3$\times$3$\times$1 and 3$\times$3$\times$1 respectively.
