...
% Image of T1, the mask itself, and the resulting image.
...
% Image of T1, FLAIR and a lacune mask coloured in red
...
\todo[inline]{CHECK THE SAMPLE NUMBERS AGAIN! IMPORTMRI.R COMMENTS ARE FOR THE OLD TOTALS.}
